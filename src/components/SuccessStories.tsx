...
const SuccessStories = () => {
  const stories = [
    ...
    {
      name: "ToknMatter",
      founder: "Austine Chisutia, Fabian Owuor & Thirdweb",
    ...
    {
      name: "Nulands",
      founder: "Joseph Kamata",
      description: "\"Buying and Selling of Land and Houses.\"",
